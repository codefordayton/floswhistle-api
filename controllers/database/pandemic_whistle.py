...
class PandemicWhistle(db.Model):
    ...
    test_none = db.Column(db.Boolean, default=False, nullable=False)
    test_tried = db.Column(db.Boolean, default=False, nullable=False)
    test_no_result = db.Column(db.Boolean, default=False, nullable=False)
    test_swab_neg = db.Column(db.Boolean, default=False, nullable=False)
    test_swab_pos = db.Column(db.Boolean, default=False, nullable=False)
    test_anti_neg = db.Column(db.Boolean, default=False, nullable=False)
    test_anti_pos = db.Column(db.Boolean, default=False, nullable=False)
